...
<table class="bordered" align="center" margin-top = "100px">
    ...
    <tr>
        <th>Serial No.</th>        
        <th>Reserved Book</th>
         <th>User whose book reserved</th>
    </tr>
    </thead>
     <?php
						$con = mysql_connect(':/cloudsql/ancient-tractor-91116:ancient-tractor-91116:sql','root','') or die("could not connect to database");
                                if(! $con)
                                {
				...
				$avail = 'Available';
                                ...
                                {
                                	if( $row['Registered_By']==$_SESSION['loginuser'])
                                    {
                                        echo "<tr>";
                                        echo "<td>".$count."</td>"; 
